...
st.set_page_config(
    page_title="ComplexFlow-Arena Features",
    page_icon="🎯",
    layout="wide")

def load_documentation():
    """Load documentation content from markdown file"""
    docs_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "docs", "FEATURES.md")
...
Features file not found. Please ensure `docs/FEATURES.md` exists in your project directory."""
