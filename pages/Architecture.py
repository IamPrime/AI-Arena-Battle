...
st.set_page_config(
    page_title="ComplexFlow-Arena Architecture",
    page_icon="🏗️",
    layout="wide")

def load_documentation():
    """Load documentation content from markdown file"""
    docs_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "docs", "ARCHITECTURE.md")
...
Architecture file not found. Please ensure `docs/ARCHITECTURE.md` exists in your project directory."""
